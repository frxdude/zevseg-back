package com.zevseg.web.jwt;

import com.zevseg.web.entity.Role;
import com.zevseg.web.exception.TokenException;
import com.zevseg.web.serviceImpl.UserDetailsServiceImpl;
...
public class JwtTokenProvider {
    ...
    private final BigInteger accessTimeInMilliseconds = new BigInteger("900000"); // 15 min
    private final BigInteger accessTimeInHourMilliseconds = new BigInteger("3600000"); // 1 hour
    ...
    public String createToken(String uid, Role role) {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + accessTimeInHourMilliseconds.intValue());
